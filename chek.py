...
GOOGLE_API_KEY = "AIzaSyCF1dKrfIHAATKJNvYnsAgoJhBmWIIebc4"
...
class VehicleDetectionProcessor:
    def __init__(self, video_file, yolo_model_path="yolo12n.pt"):
        ...
        self.areas = [
       # np.array([(392+200, 407), (382+200, 448), (840+180, 456), (834+180, 419)], np.int32),  # Area 1 middle 
       #np.array([(50, 300), (100, 350), (600, 370), (550, 320)], np.int32),  # Area 2 front
        
        np.array([(240+100, 400), (240+100, 500), (850, 500), (850, 400)], np.int32)  # Full road coverage
        ]
...
if __name__ == "__main__":
    video_file = r"C:\Users\hp\Desktop\sem-6 project AI\yolo12-with-gemini2.0-vehicle-detection-main\my.mp4"
